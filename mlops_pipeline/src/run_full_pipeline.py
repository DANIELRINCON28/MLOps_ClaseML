...
def main():
    ...
    # 1. Cargar datos
    print("\n📂 PASO 1: Cargando datos...")
    with open(PROJECT_ROOT / 'data/processed/X_train.pkl', 'rb') as f:
        X_train = pickle.load(f)
    with open(PROJECT_ROOT / 'data/processed/X_test.pkl', 'rb') as f:
    ...
    with open(PROJECT_ROOT / 'data/processed/preprocessor.pkl', 'rb') as f:
    ...
    with open(PROJECT_ROOT / 'models/xgboost_model.pkl', 'wb') as f:
        pickle.dump(model, f)
    ...
    with open(PROJECT_ROOT / 'models/model_metrics.pkl', 'wb') as f:
        pickle.dump(metrics, f)

    print(f"✅ Modelo guardado en {PROJECT_ROOT}/models/xgboost_model.pkl")
    ...
    os.makedirs(PROJECT_ROOT / 'outputs/monitoring', exist_ok=True)
    predictions_df.to_csv(PROJECT_ROOT / 'outputs/monitoring/predictions.csv', index=False)
    ...
    print("   • Modelo guardado: models/xgboost_model.pkl")
    print("   • Predicciones: outputs/monitoring/predictions.csv")

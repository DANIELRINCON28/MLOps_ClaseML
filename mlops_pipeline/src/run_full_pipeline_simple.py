...
print("=" * 80)
print("PIPELINE MLOPS COMPLETO - DETECCION DE FRAUDE")
print("=" * 80)
...
print("[OK] Modelo guardado en ../../models/xgboost_model.pkl")
...
print("[OK] Predicciones guardadas")

print("\n" + "=" * 80)
print("[COMPLETADO] PIPELINE COMPLETADO CON EXITO")
print("=" * 80)
print(f"\nResultados finales:")
